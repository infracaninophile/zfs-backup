...
# filesystem whereas the equivalent server_foo() function will operate
# on a list of filesystems read from stdin.  This may be specified
# from the command line or auto-generated by querying the client.
case $ACTION in
